...
//            else
//            {
//                LOGGER.error("Failed to deploy DatabaseVerticle: {}", res.cause().getMessage());
//            }
//        });
//    }
//
...
//            if (res.succeeded())
//            {
//                LOGGER.info("HttpVerticle deployed successfully");
//            }
//            else
//            {
//                LOGGER.error("Failed to deploy HttpVerticle: {}", res.cause().getMessage());
//            }
//        });
//    }
//
